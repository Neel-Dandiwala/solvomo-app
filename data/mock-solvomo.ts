  ...
  neel: {
    ...
    overview: {
      ...
      widgets: [
        ...
        { id: "w-roi-platform", title: "ROAS by platform", description: "Efficiency by paid channel.", source: "ad_data", visualization: "bar", datasetKey: "platformSummaries", metric: "roi", dimension: "platform", size: "sm" },
