...
export const MOCK_USERS: Record<SolvomoUserId, SolvomoMockBundle> = {
  neel: {
    ...
    overview: {
      ...
      trendPoints: [
        { date: "Mar 04", spend: 10.8, revenue: 49, qualifiedLeads: 43, deals: 7, pipelineRevenue: 88, closedRevenue: 42, conversions: 118 },
        { date: "Mar 05", spend: 11.3, revenue: 53, qualifiedLeads: 46, deals: 8, pipelineRevenue: 93, closedRevenue: 47, conversions: 122 },
        { date: "Mar 06", spend: 12.1, revenue: 58, qualifiedLeads: 51, deals: 9, pipelineRevenue: 98, closedRevenue: 53, conversions: 128 },
        { date: "Mar 07", spend: 11.9, revenue: 61, qualifiedLeads: 55, deals: 10, pipelineRevenue: 102, closedRevenue: 60, conversions: 131 },
        { date: "Mar 08", spend: 12.8, revenue: 64, qualifiedLeads: 57, deals: 10, pipelineRevenue: 105, closedRevenue: 62, conversions: 134 },
        { date: "Mar 09", spend: 13.4, revenue: 69, qualifiedLeads: 63, deals: 11, pipelineRevenue: 108, closedRevenue: 68, conversions: 141 },
        { date: "Mar 10", spend: 12.7, revenue: 76, qualifiedLeads: 71, deals: 12, pipelineRevenue: 116, closedRevenue: 76, conversions: 148 },
      ],
      platformSummaries: [
      ...
      performanceChanges: [
        { id: "pc-1", label: "Attributed revenue", delta: "+14.2%", period: "vs prior 7D" },
        { id: "pc-2", label: "Blended ROAS", delta: "+0.3x", period: "vs prior 7D" },
        { id: "pc-3", label: "Google Ads spend", delta: "+18%", period: "WoW" },
        { id: "pc-4", label: "Meta CAC", delta: "−4.1%", period: "vs prior 7D" },
      ],
      widgets: [
        ...
        { id: "w-platform-revenue", title: "Revenue by channel", description: "Attributed revenue by paid channel.", source: "ad_data", visualization: "bar", datasetKey: "platformSummaries", metric: "revenue", dimension: "platform", size: "md" },
        ...
        { id: "w-funnel", title: "Funnel", description: "Volume by funnel stage.", source: "crm_data", visualization: "bar", datasetKey: "funnel", metric: "qualified_leads", dimension: "date", size: "md" },
        ...
        { id: "w-roi-cluster", title: "Campaign efficiency", description: "Efficiency comparison across active campaign groups.", source: "ad_data", visualization: "bar", datasetKey: "campaignClusters", metric: "roi", dimension: "campaign_cluster", size: "sm" },
        ...
        { id: "w-revenue-trend", title: "Revenue trend", description: "Closed revenue movement over the selected window.", source: "summary", visualization: "line", datasetKey: "trendPoints", metric: "closed_revenue", dimension: "date", size: "sm" },
        { id: "w-conversion-trend", title: "Conversion trend", description: "Tracked conversions over the selected window.", source: "summary", visualization: "line", datasetKey: "trendPoints", metric: "conversions", dimension: "date", size: "sm" },
        { id: "w-roi-platform", title: "ROAS by channel", description: "Paid channel efficiency.", source: "ad_data", visualization: "bar", datasetKey: "platformSummaries", metric: "roi", dimension: "platform", size: "sm" },
        { id: "w-creatives-leaderboard", title: "Top creatives", description: "Highest ROAS creative cuts this period.", source: "ad_data", visualization: "table", datasetKey: "creativeLeaderboard", metric: "revenue", dimension: "channel", size: "sm" },
        { id: "w-performance-changes", title: "Recent performance changes", description: "Week-over-week shifts on key metrics.", source: "summary", visualization: "table", datasetKey: "performanceChanges", metric: "revenue", dimension: "date", size: "sm" },
      ],
      dashboards: [
        {
          id: "db-neel-default",
